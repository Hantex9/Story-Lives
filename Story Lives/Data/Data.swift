...
let nodeHappyFinal = Node(type: .Final, text: "happy final", question: "", image: #imageLiteral(resourceName: "images"), answers: nil)
let nodeSadFinal = Node(type: .Final, text: "sad final", question: "", image: #imageLiteral(resourceName: "images"), answers: nil)
...
let nodeHappyFinal2 = Node(type: .Final, text: "happy final", question: "", image: #imageLiteral(resourceName: "images"), answers: nil)
let nodeSadFinal2 = Node(type: .Final, text: "sad final", question: "", image: #imageLiteral(resourceName: "images"), answers: nil)
