...
//Go to noise - HAPPY!
let nodeHappyFinal = Node(type: .Final, text: "East starts running at breakneck speed towards the noise. Slowly, other people start to pour into the street in a chaotic way. The noises come from the Wall. What is happening? The huge expanse of cement that separates them from their loved ones is finally collapsing. A thousand curious glances could be glimpsed on the other side of the Wall, all of which remained hidden for too long. Among these East recognizes a family portrait …West.", question: "", image: #imageLiteral(resourceName: "images"), answers: nil)
//Go to sleep - SAD!
let nodeSadFinal = Node(type: .Final, text: "East goes up to his room. Finally, another day is over. What will happen tomorrow?, He asks himself resigned. But, in his heart, hopes are light. He knows nothing will change.", question: "", image: #imageLiteral(resourceName: "images"), answers: nil)
//Watch the stars ---> (GO TO NOISE - GO TO SLEEP)
let nodeNine = Node(type: .Normal, text: "East sits on the wet ground. He loves looking at the stars. Suddenly, a roar breaks through the sky and, soon after, the sound of sirens and dogs in the distance envelops the silent night.", question: "", image: #imageLiteral(resourceName: "images"), answers: [answerTen, answerEleven])
//Play with friends ---> (BACK AT HOME - GO TO NOISE)
let nodeEight = Node(type: .Normal, text: "East meets occasionally with other children. They play hide and seek among the rubbles until dusk. A loud screamm break the harmony of their game. What is happening?", question: "", image: #imageLiteral(resourceName: "images"), answers: [answerSeven, answerTen])
//Back at home ---> (SLEEP - WATCH THE STARS)
let nodeSeven = Node(type: .Normal, text: "As he enters his home, is immediately hit by the acrid smell of mold. The curved grandfather, with his por of soup, coughs from time to time. It is heartbreaking to feel helpless knowing that there is a cure a single wall away. Trying to drive away from the sad thoughts in his mind and, while pretending a smile, he sits down at the table with his grandfather, savoring the tasteless flavor of the soup.", question: "", image: #imageLiteral(resourceName: "images"), answers: [answerEleven, answerNine])
//Skip school ---> (BACK AT HOME - PLAY WITH FRIENDS)
let nodeSix = Node(type: .Normal, text: "East usually stops by at the old Alfred's shop, a small and dark bookstore. There, from time to time, the gracious librarian allows him to open a small and shabby trunk. Inside it, there are a few books with sparkling covers of many different topics. But enough talking about this for, after all, it’s their little secret.", question: "", image: #imageLiteral(resourceName: "images"), answers: [answerSeven, answerEight])
//Go to School ---> (BACK AT HOME - PLAY WITH FRIENDS)
let nodeFive = Node(type: .Normal, text: "The school is a big and cold building. The walls are pale and shabby. East reaches his few classmates and, together, they take their seats in their desks. The teacher is already there ready to start the lesson: how to assemble the tram tracks.", question: "", image: #imageLiteral(resourceName: "images"), answers: [answerSeven, answerEight])
//Sleep ---> (GO TO SCHOOL - SKIP SCHOOL)
let nodeFour = Node(type: .Normal, text: "In the morning, East wakes up with the usual smell of boiled potatoes. He does not like them very much. He eats them hastily, picks up those few shabby books and sets off on his way to school. He hates not having single book of his own. He hates studying and reading about those badly written books.", question: "", image: #imageLiteral(resourceName: "images"), answers: [answerFive, answerSix])
...
let nodeTwo = Node(type: .Normal, text: "West is his older brother. They haven’t seen each other for 5 years, since his uncles’ last visit. West is its point of reference in that surreal city devastated by the war.", question: "", image: #imageLiteral(resourceName: "images"), answers: [answerThree, answerFour])
//Start ---> (KNOW MORE - I DON’T CARE)
let nodeOne = Node(type: .Normal, text: "Berlin 1989 - East was a solitary child with very few interests. Curious? Yes, but shy. He was always always afraid of doing something wrong and getting his family in troubles. The family was the last thing he’s got even if as his eyes filled with tears whenever he thought of West.", question: "", image: #imageLiteral(resourceName: "images"), answers: [answerOne, answerTwo])
...
let nodeEight2 = Node(type: .Normal, text: "West ocasionally meets with other children at the neighborhood’s park. They play hide and seek among the trees and flowering bushes until dusk. Suddenly, a loud scream breaks the harmony of their game. What is happening?", question: "", image: #imageLiteral(resourceName: "images"), answers: [answerSeven2, answerTen2])
//Back at home ---> (GO TO SLEEP - WATCH THE STARS)
let nodeSeven2 = Node(type: .Normal, text: "As the child entered his home, he is immediately hit by the succulent smell of roasted meat. The aunt is bringing his favorite dish to the table. It is heartbreaking to enjoy all that without being able to share it with his brother, knowing that he is only one Wall away. Trying to drive away from the sad thoughts in his mind and, while pretending a smile, he sits at the table with his uncles, savoring the tasty taste of the meat.", question: "", image: #imageLiteral(resourceName: "images"), answers: [answerEleven2, answerNine2])
//Skip the school ---> (BACK TO HOME - PLAY WITH FRIENDS)
let nodeSix2 = Node(type: .Normal, text: "West used to stop at Madame Bistrot's candy shop, a bright and colorful one. There, from time to time, the affable lady allowed him to taste the freshly baked cookies.", question: "", image: #imageLiteral(resourceName: "images"), answers: [answerSeven2, answerEight2])
//Go to school ---> (BACK AT HOME - PLAY WITH FRIENDS)
let nodeFive2 = Node(type: .Normal, text: "The school is a red brick building. On the outside, two large trees surround the courtyard. West reaches his classmates, many of whom had Turkish origins and, together, they take place in their desks. The teacher was ready to start the lesson: history.", question: "", image: #imageLiteral(resourceName: "images"), answers: [answerSeven2, answerEight2])
//Sleep ---> (GO TO SCHOOL - SKIP THE SCHOOL)
let nodeFour2 = Node(type: .Normal, text: "West wakes up in the morning with the usual inviting smell of milk and chocolate, to start off the day. He eats hastily, picks up his books and sets off to the bus stop. He loves to read his books with their shining covers and the many illustrations.", question: "", image: #imageLiteral(resourceName: "images"), answers: [answerFive2, answerSix2])
//Remember ---> (GO TO SCHOOL - SKIP THE SCHOOL)
...
let characterTwo = Character(name: "Ovest", description: "West is a sunny and carefree child, also very curious and extrovert. But he is very nostalgic because he is sad without his brother.", avatar: #imageLiteral(resourceName: "images"), node: arrayCharacterTwo)
