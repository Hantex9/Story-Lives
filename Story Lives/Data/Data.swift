...
//Go to noise - HAPPY!
let nodeHappyFinal2 = Node(type: .Final, text: "West starts running at breakneck speed towards the noise. What is happening? The huge expanse of cement has finally fallen down. A thousand curious looks could be glimpsed on the other side of the Wall, all of which remained hidden for too long. Among them, West recognizes a family portrait...East.", question: "", image: #imageLiteral(resourceName: "happy-end-ovest"), answers: nil)
//Go to sleep - SAD!
...
let nodeSeven2 = Node(type: .Normal, text: "As the child entered his home, he is immediately hit by the succulent smell of roasted meat. It is heartbreaking to enjoy all that without being able to share it with his brother, knowing that he is only one Wall away. He sits at the table with his uncles, savoring the tasty taste of the meat.", question: "", image: #imageLiteral(resourceName: "torna-casa-ovest"), answers: [answerEleven2, answerNine2])
...
//Remember ---> (GO TO SCHOOL - SKIP THE SCHOOL)
let nodeThree2 = Node(type: .Normal, text: "When West, with his uncles, went to visit East and their grandfather, he brought with him the tastiest candies from the most colorful packs. But now, enough with memories, it's time to sleep. West wakes up in the morning to start off the day. He eats hastily, picks up his books and sets off to the bus stop.", question: "", image: #imageLiteral(resourceName: "Dormi Giorno - Ovest"), answers: [answerFive2, answerSix2])
//Know more ---> (REMEMBER - SLEEP)
...
let characterTwo = Character(name: "West", description: "West is a sunny and carefree child, also very curious and extrovert. But he is very nostalgic because he is sad without his brother.", avatar: #imageLiteral(resourceName: "Choose your side - Ovest"), node: arrayCharacterTwo)
